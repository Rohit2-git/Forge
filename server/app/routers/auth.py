...
async def register(payload: RegisterRequest):
    """Self-registration. This build has no role tiers — every account gets
    full access (internally stored as role="admin" only because the DB
    column/other endpoints still expect a role string; nothing in this app
    branches on it differently per-user anymore)."""
